			...
			while not rs.eof%>
                ...
                <div class="row" style="margin-bottom:5%;">
                    ...
                    <%set op=conexao.execute("select * from OPERADORAS where nome='"&rs("operadora")&"'")
					 ...
					 set rss=conexao.execute("select * from STB_ARTIGOS where categoria='PORTALCLIENTE_INFORMATIVOS' and operadora='"&idoperadora&"' order by id desc")
					 if rss.eof then%>
