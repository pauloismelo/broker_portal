...
AbreConexao
	...
	Sql = "INSERT INTO TB_SOLICITACOES (id, id_empresa, nvidas, solpor, datareg, obs, tipo, lido) VALUES ("&idz&", "&idx&", '"&request("nvidas")&"', '"&userxy&"', '"&month(now)&"/"&day(now)&"/"&year(now)&"', '"&request("obs")&"', 'vida', 'n' )"
	conexao.Execute(Sql)
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">Cotação para seguro de vida</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="index.asp">Inicio</a></li>
                            <li class="breadcrumb-item active">Cotação para seguro de vida</li>
                        </ol>
                    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
						...
						<form action="painel.asp?go=cotacao_vida" method="post" name="form01">
