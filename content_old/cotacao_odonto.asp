...
AbreConexao
	...
	Sql = "INSERT INTO TB_SOLICITACOES (id, id_empresa, nvidas, solpor, datareg, obs, tipo, lido) VALUES ("&idz&", "&idx&", '"&request("nvidas")&"', '"&userxy&"', '"&month(now)&"/"&day(now)&"/"&year(now)&"', '"&request("obs")&"', 'odonto', 'n' )"
	conexao.Execute(Sql)
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">Cotação Plano Odontológico</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="index.asp">Inicio</a></li>
                            <li class="breadcrumb-item active">Cotação Plano Odontológico</li>
                        </ol>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                    	<p class="card-title-desc">
                       		Solicite aqui uma cotação para o plano odontológico da sua empresa.<br />Basta nos informar o número de vida de beneficiários que entraremos em contato com novas informações.
                        </p>
                        
						<form action="painel.asp?go=cotacao_odonto" method="post" name="form01">
                       ...
                       <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label" for="email">Observações</label>
            				<div class="col-md-8">
                            	<textarea name="obs" rows="3" class="form-control" id="obs" style="width:98%;" placeholder="Descreva aqui informações que você julgue importantes para essa cotação."></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
