        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">Relatório de Coparticipações</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Início</a></li>
                            <li class="breadcrumb-item active">Relatório de Coparticipações</li>
                        </ol>
                    </div>
                ...
                <div class="row" style="margin-bottom:5%;">
                    ...
                    <%set op=conexao.execute("select * from OPERADORAS where nome='"&rs("operadora")&"'")
					 ...
					 set op=nothing
					  ...
					  set rss=conexao.execute("select * from STB_ARTIGOS where categoria='PORTALCLIENTE_COPART' and operadora='"&idoperadora&"' and cliente="&idx&" and contrato="&rs("id")&" order by id desc ")
					 if rss.eof then%>
                        ...
                        <div class="col-md-6 col-xl-3">
                            ...
                            <div class="card text-center">
								...
								<%else%>
									...
									<%elseif lcase(extensao(1))="doc" or lcase(extensao(1))="docx" or lcase(extensao(1))="txt" then%>
					  					<a href="https://www.<%=rss("site")%>/artigos/<%=rss("foto")%>" download="https://www.<%=rss("site")%>/artigos/<%=rss("foto")%>" class="tre18-0099ff">
										<i class="fas fa-file-word fa-3x"></i>
										</a>
                                    <%elseif lcase(extensao(1))="xls" or lcase(extensao(1))="xlsx" or lcase(extensao(1))="csv" then%>
					  					<a href="https://www.<%=rss("site")%>/artigos/<%=rss("foto")%>" download="https://www.<%=rss("site")%>/artigos/<%=rss("foto")%>" class="tre18-0099ff">
