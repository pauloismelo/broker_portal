...
AbreConexao
	...
	SQL="insert into TB_MOVIMENTACOES (id, nome, cpf, id_empresa, id_contrato, id_usuario, datareg, horareg, solpor, tipo, protocolo, downgrade_upgrade, status) values("&idp&", '"&request("nome")&"', '"&request("cpf")&"', "&idx&", "&request("idcontrato")&", "&request("idusuario")&", '"&date&"', '"&hour(now)&":"&minute(now)&"', '"&userxy&"', 'DOWNGRADE', '"&protocolo&"', '"&request("plano")&"', 'ENVIADO')"
	response.Write(SQL)
	conexao.execute(SQL)
	
	response.Write("<script>alert('Downgrade solicitado com Sucesso!');</script>")
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">Downgrade de Plano</h4>
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Downgrade de Plano</li>
                        </ol>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                    	<p class="card-title-desc">
                       		Solicitar alteração de plano para plano inferior ao atual
                        </p>
                        <p>
                            <div class="alert alert-danger alert-dismissible fade show mt-4 px-4 mb-0 text-center">
                                ...
                                <p>Solicitações de <strong>Downgrade</strong> não são efetuadas automaticamente. A alteração depende de autorização da operadora.<br />Assim que nosso departamento de manutenção receber a resposta da operadora  informaremos sobre o resultado.<br />Via de regra a operadora só aceita pedidos de Downgrade e Upgrade na data de aniversário do contrato.</p>
						...
						<form action="painel.asp?go=downgrade" method="post" name="form01">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12 text-center">
                                ...
                                <button type="submit" class="btn btn-success waves-effect waves-light">
                                    <i class="uil uil-check mr-2"></i> Solicitar Downgrade
                                </button>
                                <%end if%>
                            </div>
                        </div>
