                ...
                <div class="row" style="margin-bottom:5%;">
                    ...
                    <%set op=conexao.execute("select * from OPERADORAS where nome='"&rs("operadora")&"'")
					 ...
					 set op=nothing
					  ...
					  set rss=conexao.execute("select * from STB_ARTIGOS where categoria='PORTALCLIENTE_FATURA' and operadora='"&idoperadora&"'  and cliente="&idx&" and contrato="&rs("id")&" order by id desc")
					 if rss.eof then%>
                            ...
                            <div class="card text-center">
								...
								<%else%>
									...
									<%elseif lcase(extensao(1))="doc" or lcase(extensao(1))="docx" or lcase(extensao(1))="txt" then%>
					  					<a href="http://www.<%=rss("site")%>/artigos/<%=rss("foto")%>" download="https://www.<%=rss("site")%>/artigos/<%=rss("foto")%>" class="tre18-0099ff">
