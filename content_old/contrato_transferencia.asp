    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div>
                    <h6>Selecione o beneficiário que deseja transferir</h6>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-12">
            	<form action="painel.asp?go=contrato_transferencia" method="post">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
						...
						Aqui você pode transferir um dos beneficiários para um outro CNPJ do mesmo grupo.
                        </p>
								...
								<%if trim(rs2("movimentacoes_autorizadas_exclusao"))="n" then%>                                  &nbsp;<i class="fas fa-info-circle" title="Em função do aviso prévio emitido, as movimentações desse contrato não poderão ser efetivadas via portal."></i>
                                  ...
                                  <%else%>
                                        <%if rs2("status")="ATIVO" or rs2("status")="CADASTRO" then%>
                                            <a href="painel.asp?go=transferencia&id=<%=rs("id")%>&contrato=<%=request("id")%>"><i class="fas fa-exchange-alt"></i></a>
                                        <%end if%>
                                  <%end if%> 
