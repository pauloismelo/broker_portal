...
'arquivo="RELATORIO_BENEFICIARIOS-"&request("idcadvenda")&"-"&databrx2(date)&".pdf"
	...
	AbreConexao
	  ...
	  set ven=nothing
		...
		'myMail.Bcc="luciano@compactasaude.com;pauloisaquecpd@hotmail.com"
		
		'response.Write(caminho)
		'response.End()
		myMail.AddAttachment caminho&"\phpexcel\"&request("nomearquivo")
		...
		response.Write("<script>window.location='https://portalcompacta.com.br/index.asp';</script>")
