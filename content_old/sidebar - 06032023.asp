    ...
    <div data-simplebar="" class="sidebar-menu-scroll">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li <%if request("go")="docboleto" or request("go")="docfatura" or request("go")="doccopart" or request("go")="docnf" then%>class="mm-active"<%end if%>>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="fas fa-dollar-sign"></i>
                        <span>Gestão Financeira</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="painel.asp?go=docboleto"<%if request("go")="docboleto" then%> class="active"<%end if%>>
                        Boleto e Fatura
                        </a></li>
                        <%set rs=conexao.execute("select id from CADASTROGERAL_VENDAS where idcadastro="&idx&" and solicita_fatura_excel='on'")
						if not rs.eof then%>
							<li><a href="painel.asp?go=docfatura"<%if request("go")="docfatura" then%> class="active"<%end if%>>
                            Faturas em Excel / TXT
                            </a></li>	
						<%end if
						set rs=nothing%>
                        
                        <li>
                        <a href="painel.asp?go=doccopart_boleto"<%if request("go")="doccopart_boleto" then%> class="active"<%end if%>>
                        Boleto Copart.
                        </a>
                        </li>
                        <li>
                        <a href="painel.asp?go=doccopart_relatorio"<%if request("go")="doccopart_relatorio" then%> class="active"<%end if%>>
                        Relatório Copart.
                        </a>
                        </li>
                        <li><a href="painel.asp?go=docnf"<%if request("go")="docnf" then%> class="active"<%end if%>>
                        Notas Fiscais
                        </a></li>
                    </ul>
                </li>
