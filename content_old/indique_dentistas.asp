...
AbreConexao
	...
	Sql = "INSERT INTO INDICACAO_PROFISSIONAL (id, id_empresa, nome, registro, celular, especialidade, solpor, datareg, obs, tipo) VALUES ("&idz&", "&idx&", '"&request("nome")&"', '"&request("registro")&"', '"&request("cel")&"', '"&request("especialidade")&"', '"&userxy&"', '"&month(now)&"/"&day(now)&"/"&year(now)&"', '"&request("obs")&"', 'dentista' )"
	conexao.Execute(Sql)

	response.Write("<script>alert('Indicacao enviada com sucesso\nEncaminharemos a Operadora!');</script>")
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">Indique seu dentista</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="index.asp">Inicio</a></li>
                            <li class="breadcrumb-item active">Indique seu dentista</li>
                        </ol>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                    	<p class="card-title-desc">
                       		Encaminharemos essa solicitação à operadora para o possível credenciamento do dentista.
                        </p>
                        
						<form action="painel.asp?go=indique_dentistas" method="post" name="form01">
                       ...
                       <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label" for="registro">CRO</label>
            				<div class="col-md-9">
